...
if answer == "left":
    ...
    if answer == "back":
        ...
        if answer == "yes":
            answer = input("You talked to the Stranger and he gave you the map.Do you like to follow the map(yes/no).")
            if answer == "yes":
                print("You followed the map and found the hidden GolDDDDDD!!")
        elif answer == "no":
